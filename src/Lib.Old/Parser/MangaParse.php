    ...
    public function parse(): array
    {
        ...
        $this->addRule(
            ...
            function () {
                ...
                preg_match(
                    '~myanimelist.net/(.+)/(.*)/~',
                    $this->model->get('Manga', 'link_canonical'),
                    $this->matches
                );
        ...
        $this->addRule(
            'title',
            '~<h1 class="h1"><span itemprop="name">(.*)</span></h1>~',
            function () {
        ...
        $this->addRule(
            'title_english',
            '~<span class="dark_text">English:</span> (.*?)</div>~',
            function () {
        ...
        $this->addRule(
            'title_synonyms',
            '~<span class="dark_text">Synonyms:</span> (.*)</div><div class="spaceit_pad"><span class="dark_text">Japanese:</span>~',
            function () {
        ...
        $this->addRule(
            'title_japanese',
            '~<span class="dark_text">Japanese:</span>(.*?)</div>~',
            function () {
        ...
        $this->addRule(
            'status',
            '~<div class="spaceit"><span class="dark_text">Status:</span> (.*)</div>~',
            function () {
        ...
        $this->addRule(
            'image_url',
            '~<img src="(.*)" alt="(.*)" itemprop="image" class="ac">~',
            function () {
        ...
        $this->addRule(
            'type',
            '~<span class="dark_text">Type:</span> <a href="(.*)">(.*?)</a></div>~',
            function () {
        ...
        $this->addRule(
            ...
            function () {
                ...
                if (!empty($this->model->get('Manga', 'published_string')) && $this->model->get(
                        'Manga',
                        'published_string'
                    ) != 'Not available') {
                    if (strpos($this->model->get('Manga', 'published_string'), 'to')) {
                        ...
                        $this->model->set(
                            ...
                            'published',
                            [
                                'from' => (strpos($this->matches[1], '?') !== false) ? null : @date_format(
                                    date_create($this->matches[1]),
                                    'o-m-d'
                                ),
                                'to'   => (strpos($this->matches[2], '?') !== false) ? null : @date_format(
                                    date_create($this->matches[2]),
                                    'o-m-d'
                                ),
                            ]
                        );
                        ...
                        if (preg_match('~^[0-9]{4}$~', $this->model->get('Manga', 'published_string'))) {
                            ...
                            $this->model->set(
                                ...
                                [
                                    'from' => (strpos(
                                            $this->model->get('Manga', 'published_string'),
                                            '?'
                                        ) !== false) ? null : @date_format(
                                        date_create($this->model->get('Manga', 'published_string')),
                                        'o-m-d'
                                    ),
                                    'to'   => (strpos(
                                            $this->model->get('Manga', 'published_string'),
        ...
        $this->addRule(
            'rank',
            '~<span class=\"dark_text\">Ranked:<\/span> #(.*[[:alnum:]])<sup>~',
            function () {
                $this->model->set(
                    'Manga',
                    'rank',
        ...
        $this->addRule(
            'score',
            '~<span class="dark_text">Score:</span> <span itemprop="ratingValue">(.*)</span><sup><small>1</small></sup> <small>\(scored by <span itemprop="ratingCount">(.*)</span> users\)</small>~',
            function () {
        ...
        $this->addRule(
            'score2',
            '~<div class="po-r js-statistics-info di-ib" data-id="info1"><span class="dark_text">Score:</span> (.*)<sup><small>1</small></sup> <small>\(scored by (.*) users\)</small>~',
            function () {
        ...
        $this->addRule(
            'popularity',
            '~<span class=\"dark_text\">Popularity:<\/span> #(.*[[:alnum:]])<\/div>~',
            function () {
                $this->model->set(
                    'Manga',
                    'popularity',
        ...
        $this->addRule(
            'members',
            '~<span class="dark_text">Members:</span>(.*)</div>~',
            function () {
                $this->model->set(
                    'Manga',
                    'members',
        ...
        $this->addRule(
            'favorites',
            '~<div><span class="dark_text">Favorites:</span> (.*)</div>~',
            function () {
                $this->model->set(
                    'Manga',
                    'favorites',
        ...
        $this->addRule(
            ...
            function () {
                if (!preg_match('~No background information has been added to this title.~', $this->line)) {
                    if (preg_match(
                        '~</div>Background</h2>([\s\S]*)<div class="border_top~',
                        $this->line,
                        $this->matches
                    )) {
                        $this->model->set(
        ...
        $this->addRule(
            ...
            function () {
                ...
                foreach ($related as $key => $value) {
                    if (!empty($value)) {
                        if (preg_match(
                            '~<td nowrap="" valign="top" class="ar fw-n borderClass">(.*)</td>~',
                            $value,
                            $this->matches
                        )) {
