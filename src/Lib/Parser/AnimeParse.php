...
class AnimeParse extends TemplateParse
{
    ...
    public function parse(): array
    {
        ...
        $this->addRule(
            'image_url',
            '~<img src="(.*)" alt="(.*)" class="ac" itemprop="image">~',
            function () {
        ...
        $this->addRule(
            ...
            function () {
                ...
                if (!empty($this->model->get('Anime', 'aired_string')) && $this->model->get(
                        'Anime',
                        'aired_string'
                    ) != 'Not available') {
                            ...
                            $this->model->set(
                                ...
                                [
                                    'from' => (strpos(
                                        ...
                                        date_create($this->model->get('Anime', 'aired_string')),
                                        'o-m-d'
                                    ),
                                    'to'   => (strpos(
                                            $this->model->get('Anime', 'aired_string'),
        ...
        $this->addRule(
            'opening_theme',
            '~<div class="theme-songs js-theme-songs opnening">([\s\S]*)</div>~',
            function () {
        ...
        $this->addRule(
            'ending_theme',
            '~<div class="theme-songs js-theme-songs ending">([\s\S]*)</div>~',
            function () {
                preg_match_all('~<span class="theme-song">(.*?)</span>~', $this->matches[1], $this->matches);
                foreach ($this->matches[1] as $key => &$value) {
                    $value = htmlspecialchars_decode($value);
