...
class AnimeStatsParse extends TemplateParse
{
    ...
    public function parse(): array
    {
        ...
        $this->addRule(
            'watching',
            '~<div class="spaceit_pad"><span class="dark_text">Watching:</span> (.*)</div>~',
            function () {
                $this->model->set(
                    'AnimeStats',
                    'watching',
        ...
        $this->addRule(
            'completed',
            '~<div class="spaceit_pad"><span class="dark_text">Completed:</span> (.*)</div>~',
            function () {
                $this->model->set(
                    'AnimeStats',
                    'completed',
        ...
        $this->addRule(
            'on_hold',
            '~<div class="spaceit_pad"><span class="dark_text">On-Hold:</span> (.*)</div>~',
            function () {
                $this->model->set(
                    'AnimeStats',
                    'on_hold',
        ...
        $this->addRule(
            'dropped',
            '~<div class="spaceit_pad"><span class="dark_text">Dropped:</span> (.*)</div>~',
            function () {
                $this->model->set(
                    'AnimeStats',
                    'dropped',
        ...
        $this->addRule(
            'plan_to_watch',
            '~<div class="spaceit_pad"><span class="dark_text">Plan to Watch:</span> (.*)</div>~',
            function () {
                $this->model->set(
                    'AnimeStats',
                    'plan_to_watch',
        ...
        $this->addRule(
            'total',
            '~<div class="spaceit_pad"><span class="dark_text">Total:</span> (.*)</div>~',
            function () {
                $this->model->set(
                    'AnimeStats',
                    'total',
            ...
            function () {
                ...
                while (true) {
                    ...
                    if (preg_match('~<td width="20">(.*?)</td>~', $line, $this->matches)) {
                        ...
                        $i++;
                        preg_match(
                            '~<td><div class="spaceit_pad"><div class="updatesBar" style="(.*?)"></div><span>&nbsp;(.*?)% <small>\((.*?) votes\)</small></span></div></td>~',
