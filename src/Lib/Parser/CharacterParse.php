    ...
    public function parse(): array
    {
        ...
        $this->addRule(
            ...
            function () {
                ...
                preg_match(
                    '~myanimelist.net/(.+)/(.*)/~',
                    $this->model->get('Character', 'link_canonical'),
                    $this->matches
                );
        ...
        $this->addRule(
            'name',
            '~<div class="normal_header" style="height: 15px;">(.*) (<span style="font-weight: normal;"><small>(.*)</small></span>|)</div>~',
            function () {
        ...
        $this->addRule(
            'nicknames',
            '~<div id="contentWrapper"><div><div class="header-right">~',
            function () {
        ...
        $this->addRule(
            'about',
            '~<div class="normal_header" style="height: 15px;">(.*) (<span style="font-weight: normal;"><small>(.*)</small></span>|)</div>(.*?)<br />~',
            function () {
                $match = [];
            ...
            function () {
                ...
                while ($running) {
                    ...
                    if (preg_match('~<tr>~', $line)) {
                        ...
                        $this->matches = [];
                        preg_match(
                            '~<td width="25" class="borderClass" valign="top"><div class="picSurround"><a href="(.*)"><img src="(.*)" border="0"></a></div></td>~',
                        ...
                        $animeName = [];
                        preg_match(
                            '~<td valign="top" class="borderClass"><a href="((.*)/(.*)/(.*)/(.*))">(.*)</a>~',
                            $this->file[$this->lineNo + $i],
                            $animeName
                        );
                        $i++;
            ...
            function () {
                ...
                while ($running && $line = $this->file[$this->lineNo + $i]) {
                    ...
                    if (preg_match('~<tr>~', $line)) {
                        ...
                        $personMeta = [];
                        preg_match(
                            '~<td class="borderClass" valign="top" width="25"><div class="picSurround"><a href="(.*)"><img src="(.*)" border="0"></a></div></td>~',
                            $this->file[$this->lineNo + $i],
                            $personMeta
                        );
                        $i++;
                        $personName = [];
                        preg_match(
                            '~<td class="borderClass" valign="top"><a href="((.*)/(.*)/(.*)/(.*))">(.*)</a>~',
                            $this->file[$this->lineNo + $i],
                            $personName
                        );
                        $i++;
                        $personType = [];
                        preg_match(
                            '~<div style="margin-top: 2px;"><small>(.*)</small></div>~',
                            $this->file[$this->lineNo + $i],
                            $personType
                        );
        ...
        $this->addRule(
            'image_url',
            '~<td width="225" class="borderClass" style="border-width: 0 1px 0 0;" valign="top"><div style="text-align: center;">(<a href="(.*)"><img src="(.*)" alt="(.*)"></a>|<a href="(.*)" class="btn-detail-add-picture"><i class="fa fa-plus-circle fs18 icon-plus-circle"></i><i class="fa fa-camera fs48"></i><br><span class="text">Add Picture</span></a></a>)</div>~',
            function () {
