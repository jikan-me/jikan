            ...
            function () {
                ...
                while (true) {
                    ...
                    if (preg_match('~<tr id="topicRow([0-9]{1,})">~', $line)) {
                        ...
                        preg_match(
                            '~<td class="forum_boardrow([0-9]{1,})" style="border-width: 0px 1px 1px 0px;">(Poll: |) <a href="/(.*)">(.*)</a> <small>(.*?)</small><br><span class="forum_postusername"><a href="/(.*)">(.*)</a></span> - <span class="lightLink">(.*)</span></td>~',
                        ...
                        $i++;
                        preg_match(
                            '~<td align="center" width="75" class="forum_boardrow([0-9]{1,})" style="border-width: 0px 1px 1px 0px;">(.*)</td>~',
                            $this->file[$this->lineNo + $i],
                            $this->matches
                        );
                        ...
                        $i++;
                        preg_match(
                            '~<td align="right" width="130" class="forum_boardrow([0-9]{1,})" style="border-width: 0px 1px 1px 0px;" nowrap>by <a href="/(.*)">(.*)</a> <a href="/(.*)" title="Go to the Last Post">&raquo;&raquo;</a><br>(.*)</td>~',
                            $this->file[$this->lineNo + $i],
                            $this->matches
                        );
                ...
                $this->model->set('MangaForum', 'topic', $topics);
            }
        );
