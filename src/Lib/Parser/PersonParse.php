    ...
    public function parse(): array
    {
        ...
        $this->addRule(
            ...
            function () {
                ...
                preg_match(
                    '~myanimelist.net/(.+)/(.*)/~',
                    $this->model->get('Person', 'link_canonical'),
                    $this->matches
                );
        ...
        $this->addRule(
            'given_name',
            '~<div class="spaceit_pad"><span class="dark_text">Given name:</span> (.*)</div>~',
            function () {
        ...
        $this->addRule(
            'family_name',
            '~<span class="dark_text">Family name:</span> (.*)<div class="spaceit_pad"><span class="dark_text">Alternate names:</span>~',
            function () {
        ...
        $this->addRule(
            'alternate_name',
            '~<span class="dark_text">Alternate names:</span> (.*)</div><div class="spaceit_pad">~',
            function () {
        ...
        $this->addRule(
            'birthday',
            '~<span class="dark_text">Birthday:</span> (.*)</div><span class="dark_text">Website:</span>~',
            function () {
        ...
        $this->addRule(
            'website_url',
            '~<span class="dark_text">Website:</span> <a href="(.*?)">(.*)</a>~',
            function () {
        ...
        $this->addRule(
            'member_favorites',
            '~<div class="spaceit_pad"><span class="dark_text">Member Favorites:</span> (.*)</div>~',
            function () {
        ...
        $this->addRule(
            'more',
            '~<div class="people-informantion-more js-people-informantion-more">(.*)?~',
            function () {
            ...
            function () {
                ...
                while ($running) {
                    ...
                    if (preg_match('~<tr>~', $line)) {
                        ...
                        $animeMeta = [];
                        preg_match(
                            '~<td valign="top" class="borderClass" width="25"><div class="picSurround"><a href="(.*)"><img data-src="(.*)" border="0" width="23" class="lazyload"></a></div></td>~',
                        ...
                        $animeName = [];
                        preg_match(
                            '~<td valign="top" class="borderClass"><a href="((.*)/(.*)/(.*)/(.*))">(.*)</a><div class="spaceit_pad">~',
                            $this->file[$this->lineNo + $i],
                            $animeName
                        );
                        $i += 2;
                        $char = [];
                        preg_match(
                            '~<td valign="top" class="borderClass" align="right" nowrap><a href="((.*)/(.*)/(.*)/(.*))">(.*)</a>&nbsp;<div class="spaceit_pad">(.*)&nbsp;</div></td>~',
                            $this->file[$this->lineNo + $i],
                            $char
                        );
                        ...
                        $charMeta = [];
                        preg_match(
                            '~<td valign="top" class="borderClass" width="25"><div class="picSurround"><a href="(.*)"><img data-src="(.*)" border="0" alt="(.*)" width="23" class="lazyload"></a></div></td>~',
                            $this->file[$this->lineNo + $i],
                            $charMeta
                        );
            ...
            function () {
                ...
                while ($running) {
                    ...
                    if (preg_match('~<tr>~', $line)) {
                        ...
                        $role = [];
                        preg_match(
                            '~<a href="(.*)" title="Quick add anime to my list" class="button_add">add</a> <small>(.*)</small>~',
                            $this->file[$this->lineNo + $i],
                            $role
                        );
                        $animeStaffPositions[] = [
            ...
            function () {
                ...
                while ($running) {
                    ...
                    if (preg_match('~<tr>~', $line)) {
                        ...
                        $role = [];
                        preg_match(
                            '~<a href="(.*)" title="Quick add manga to my list" class="button_add">add</a> <small>(.*)</small>~',
                            $this->file[$this->lineNo + $i],
                            $role
                        );
                        $publsihedManga[] = [
        ...
        $this->addRule(
            'image_url',
            '~<td width="225" class="borderClass" style="border-width: 0 1px 0 0;" valign="top"><div style="text-align: center; style="margin-bottom: 3px;">(<a href="(.*)"><img src="(.*)" alt="(.*)"></a>|<a href="(.*)" class="btn-detail-add-picture"><i class="fa fa-plus-circle fs18 icon-plus-circle"></i><i class="fa fa-camera fs48"></i><br><span class="text">Add Picture</span></a></a>)</div>~',
            function () {
