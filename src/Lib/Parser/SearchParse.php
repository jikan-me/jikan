    ...
    public function parse($type = ANIME, $status): Array
    {
        ...
        switch ($type) {
            ...
            case MANGA:
                $this->addRule(
                    'title',
                    '~<meta property="og:type" content="(books.book|video.tv_show)">~',
                    function () {
                        $results = [];
                        $result = [
                            'mal_id'      => null,
                        ...
                        while (true) {
                            ...
                            if (preg_match('~<meta property="og:url" content="(.*?)">~', $line, $this->matches)) {
                                ...
                                preg_match(
                                    '~https://myanimelist.net/(anime|manga)/(.*)/(.*)~',
                                    $this->matches[1],
                                    $this->matches
                                );
                            ...
                            if (preg_match('~<span class="dark_text">Score:</span>~', $line)) {
                                preg_match(
                                    '~<span(.*?)>(.*)</span><sup>1</sup> \(scored by <span(.*?)>(.*)</span> users\)~',
                                    $this->file[$this->lineNo + $i + 1],
                                    $this->matches
                                );
                ...
                $this->addRule(
                    ...
                    function () {
                        ...
                        while (true) {
                            ...
                            if (preg_match(
                                '~^<td class="borderClass bgColor(0?|1?)" valign="top" width="50">$~',
                                $line
                            )) {
                                $i += 2;

                                preg_match(
                                    '~<a class="hoverinfo_trigger" href="((.*)/(.*)/(.*))" id="(.*)" rel="(.*)">~',
                                ...
                                preg_match(
                                    '~<img width="50" height="70" alt="(.*)" border="0" data-src="(.*)" data-srcset="(.*)" class="lazyload" />~',
                                    $this->file[$this->lineNo + $i],
                                    $this->matches
                                );
                                ...
                                if (preg_match(
                                    '~<div class="pt4">(.*?)(.?|<a href=".{1,}">read more.</a>)</div>~',
                                    $this->file[$this->lineNo + $i],
                                    $this->matches
                                )) {
                                    $result['description'] = utf8_encode(
                                        trim(htmlspecialchars_decode($this->matches[1], ENT_QUOTES))
                                    );
                                }
                                ...
                                $i += 2;
                                $result[$this->type == ANIME ? 'episodes' : 'volumes'] = (int)trim(
                                    $this->file[$this->lineNo + $i]
                                );
                                $i += 2;
            ...
            case CHARACTER:
                $this->addRule(
                    'result',
                    '~<td class="normal_header" colspan="4">Search Results</td>~',
                    function () {
                        $i = 0;
                        $results = [];
                        while (true) {
                            ...
                            if (preg_match(
                                '~<td class="borderClass bgColor(1?|2?)" width="30"><div class="picSurround"><a href="((.*)/(.*)/(.*))"><img src="(.*)" border="0"></a></div>~',
                                $line,
                                $this->matches
                            )) {
                                ...
                                if (preg_match(
                                        '~<td class="borderClass bgColor(1?|2?)"><small> Anime: (.*)<div>Manga: (.*)</div></small></td>~',
                                        $this->file[$this->lineNo + $i],
                                        $this->matches
                                    )
                                    || preg_match(
                                        '~<td class="borderClass bgColor(1?|2?)"><small> Anime: (.*)</small></td>~',
                                        $this->file[$this->lineNo + $i],
                                        $this->matches
                                    )
                                    || preg_match(
                                        '~<td class="borderClass bgColor(1?|2?)"><small> <div>Manga: (.*)</div></small></td>~',
                                        $this->file[$this->lineNo + $i],
                                        $this->matches
                                    )
                                ) {
                ...
                $this->addRule(
                    ...
                    function () {
                        ...
                        while (true) {
                            ...
                            if (preg_match(
                                '~<td class="borderClass" width="25"><div class="picSurround"><a href="(/(.*)/(.*)/(.*))"><img src="(.*)"></a></div></td>~',
                                $line,
                                $this->matches
                            )) {
                                $result['mal_id'] = (int)$this->matches[3];
                                ...
                                $i++;
                                preg_match(
                                    '~<td class="borderClass"><a href="(.*)">(.*)</a>(<br><small>(.*)</small></td>|)~',
                                    $this->file[$this->lineNo + $i],
                                    $this->matches
                                );
                                $result['name'] = $this->matches[2];
        ...
        $this->addRule(
            'result_last_page',
            '~<div class="spaceit" style="text-align: right;">~',
            function () {
