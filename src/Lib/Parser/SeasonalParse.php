...
class SeasonalParse extends TemplateParse
{
    ...
    public function parse(): Array
    {
        ...
        $this->addRule(
            'season_meta',
            '~<meta property="og:title" content="(.*) - Anime - MyAnimeList.net ">~',
            function () {
        ...
        $this->addRule(
            ...
            function () {
                ...
                while (true) {
                    ...
                    if (preg_match('~<div class="anime-header">ONA</div>~', $this->file[$this->lineNo + $i])) {
                        $continued = false;
                    }
                    ...
                    if (preg_match(
                        ...
                        while (!preg_match('~<div class="info">~', $this->file[$this->lineNo + $i])) {
                            $i++;
                        } // haxing MAL's inconsistencies
                        $i++;
