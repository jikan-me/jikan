            ...
            function ($type) {
                ...
                while (true) {
                    ...
                    if (preg_match('~<tr class="ranking-list">~', $this->file[$this->lineNo + $i])) {
                        ...
                        $i += 2;
                        if (preg_match(
                            '~<span class="lightLink top-anime-rank-text rank([0-9]{1,})">(.*?)</span>~',
                        ...
                        $i += 3;
                        if (preg_match(
                            '~<a class="hoverinfo_trigger fl-l ml12 mr8" href="(https://myanimelist.net/(.*)/(.*)/(.*))" id="(.*?)" rel="(.*?)">~',
                            $this->file[$this->lineNo + $i],
                            $this->matches
                        )) {
                        ...
                        $i++;
                        if (preg_match(
                            '~<img width="50" height="70" alt="(.*?)" class="lazyload" border="0" data-src="(.*?)" />~',
                            $this->file[$this->lineNo + $i],
                            $this->matches
                        )) {
                        ...
                        if (preg_match(
                            '~<a class="hoverinfo_trigger(.*?)" href="(.*?)" id="(.*?)" rel="(.*?)">(.*?)</a>~',
                            $this->file[$this->lineNo + $i],
                            $this->matches
                        )) {
                        ...
                        if (preg_match(
                            '~<i class="icon-score-star mr4 on"></i><span class="text on">(.*)</span>~',
                            $this->file[$this->lineNo + $i],
                            $this->matches
                        )) {
